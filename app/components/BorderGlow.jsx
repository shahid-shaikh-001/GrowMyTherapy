...
export default function BorderGlow({
  ...
  const [cursorAngle, setCursorAngle] =
    useState(45);

  const [edgeProximity, setEdgeProximity] =
    useState(0);

  const [sweepActive, setSweepActive] =
    useState(false);
...
requestAnimationFrame(() => {
  ...
  const angleDeg = `${cursorAngle.toFixed(
    3
  )}deg`;
